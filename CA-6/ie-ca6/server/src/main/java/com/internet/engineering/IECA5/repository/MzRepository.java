...
import com.internet.engineering.IECA5.repository.Device.DeviceMapper;
import com.internet.engineering.IECA5.repository.Day.DayMapper;
import com.internet.engineering.IECA5.repository.Grade.GradeMapper;
import com.internet.engineering.IECA5.repository.Prerequisite.PrerequisiteMapper;
import com.internet.engineering.IECA5.repository.Student.StudentMapper;
import com.internet.engineering.IECA5.repository.WeeklyScheduleItem.WeeklyScheduleItemMapper;
...
public class MzRepository {
    ...
    public void createAllTables() {
        try {
            DeviceMapper deviceMapper = new DeviceMapper(true);
        } catch (Exception e) {
            e.printStackTrace();
        }
        try {
    ...
    public Device getDeviceById(String id) throws SQLException {
        ...
        args.add(id);
        return new DeviceMapper().getDeviceById(new CustomPair(args));
    }

    public List<Device> searchDevices(String name) throws SQLException {
        return new DeviceMapper().search(name);
    }
    ...
    public void deleteDevice(String deviceId) throws SQLException {
        ...
        args.add(deviceId);
        DeviceMapper deviceMapper = new DeviceMapper();
        deviceMapper.delete(new CustomPair(args));
    }
    ...
    public List<Offering> searchCors(String name) throws SQLException {
